...
import imagem from "/Users/Usuario/Desktop/Projetos Pessoais Github/Personal Page/personal-page/personal-page/public/Eu.jpeg"
  ...
  return (
    <div className={styles.mainDiv} id="QuemSouEu">
       ...
       <div className={styles.msgCont}>
        <h1>Sobre mim:</h1>
        <span>Apenas um garoto apaixonado por programação!</span>
        ...
        <ul className={styles.socialLinks}>
          <li> <a href="https://www.linkedin.com/in/leandro-neves-lhoneves/"> <img src="./instagram.jpeg" alt="LinkedIn logo" /></a></li>
